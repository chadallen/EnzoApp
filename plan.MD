...
## Current Status — 2026-04-19 (Session 1)
...
| **Re-sync shows spinner over existing data** | Decision: keep existing list visible, show subtle indicator. Tracked as `75h.15` (depends on `75h.1`, now closed). |
